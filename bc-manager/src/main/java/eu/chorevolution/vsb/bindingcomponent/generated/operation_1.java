 ...
 * 
 */
public class operation_1 extends Operation {


    public operation_1() {
        super("operation_1", new QName("BasicServices", DPWSDevice.DOCU_NAMESPACE));
        ComplexType complexInputElem;
        complexInputElem = new ComplexType(new QName("complexInput", DPWSDevice.DOCU_NAMESPACE), ComplexType.CONTAINER_SEQUENCE);
        Element arg0Elem;
