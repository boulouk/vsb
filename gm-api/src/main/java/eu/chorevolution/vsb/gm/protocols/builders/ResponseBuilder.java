...
public class ResponseBuilder {
	public static <T> T unmarshalObject(final String mediaType,
			final String serializedObject, final Class<T> responseClass) {
		switch (mediaType) {
		case "application/json":
			return ResponseBuilder.unmarshalObjectFromJson(serializedObject,
					responseClass);
		default:
			// TODO find, or create, a better and more explicit exception, similar to
			// 415 HTTP error ?
	...
	private static <T> T unmarshalObjectFromJson(final String serializedObject,
