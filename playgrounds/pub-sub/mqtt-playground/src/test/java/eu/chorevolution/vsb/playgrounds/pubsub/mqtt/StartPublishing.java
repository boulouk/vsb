...
public class StartPublishing {
	...
	public static void main(String[] args) {
		mqttPublisher pub = null;
		pub = new mqttPublisher("localhost",1883, "publisher6");
		pub.publish("getMetadataInArea", "{\"arg0\":\"17.4781747,78.2975116,15.51z\",\"arg1\":\"17.470432,78.3102378,15z\",\"key\": \"AIzaSyBhfNR1PHo8EsuxjLr3EO-sNnfoUDh4ilw\"}");
