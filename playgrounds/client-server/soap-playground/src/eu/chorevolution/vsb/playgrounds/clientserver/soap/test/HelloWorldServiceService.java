 ...
 * 
 */
@WebServiceClient(name = "HelloWorldServiceService", targetNamespace = "http://test.soap.clientserver.playgrounds.vsb.chorevolution.eu/", wsdlLocation = "http://localhost:8080/HelloWorldService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICESERVICE_QNAME = new QName("http://test.soap.clientserver.playgrounds.vsb.chorevolution.eu/", "HelloWorldServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HelloWorldService?wsdl");
    ...
    public HelloWorldService getHelloWorldServicePort() {
        return super.getPort(new QName("http://test.soap.clientserver.playgrounds.vsb.chorevolution.eu/", "HelloWorldServicePort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.soap.clientserver.playgrounds.vsb.chorevolution.eu/", "HelloWorldServicePort"), HelloWorldService.class, features);
    }
